...
const ObjectReactFilter = () => {
    ...
    const filterByBrand = (filteredData) => {
        ...
        debugger
        const filteredCars = filteredData.filter((car) => car.name.split(" ")
    ...
    const filterByYear = (filteredData) => {
        ...
        const filteredCars = filteredData.filter((car) => car.release_year === selectedYear)
        return filteredCars
    }
    ...
    return (
        <div className="App">
            ...
            <div id="year-options" onClick={handleYearChange}>
                <div className={selectedYear === 2018 ? "active-option" : "filter-option"} id="2018">
                    2018
                </div>
                <div
...
export default ObjectReactFilter
